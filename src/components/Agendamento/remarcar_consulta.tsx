...
import './remarcar_consulta.css';

interface Remarcar_ConsultaProps {
    onLogout: () => void;
}

const Remarcar_Consulta: React.FC<Remarcar_ConsultaProps> = ({ onLogout }) => {
    ...
    const [reagendamentoMessage, setReagendamentoMessage] = useState('');
    ...
    const handleSubmit = (event: React.FormEvent) => {
        ...
        setReagendamentoMessage('Consulta reagendada com sucesso!');
        setShowMessage(true);
        ...
        setTimeout(() => {
            ...
            setReagendamentoMessage('');
        }, 5000);
    };

    return (
        <div className="remarcar_consulta-container">
            <header className="remarcar_consulta-header">
            ...
            <main className="content-wrapper">
                <div className="main-title-container">
                    <h2 className="main-title">Remarcar Consulta</h2>
                </div>
                    ...
                    <div className="form-content">
                        ...
                        <form className="inputs" onSubmit={handleSubmit}>
                            <div className="button-container">
                                ...
                                <button className="btn-reagendar" type="submit">Reagendar</button>
                            </div>
                        </form>
                    </div>
                </div>
...
export default Remarcar_Consulta;